...
// Function to create a new course  (ok)
exports.createCourse = async (req, res) => {
  try {
    ...
    const thumbnail = req.files?.thumbnail;//thumbnailImage
  ...
  console.log("taglength :", tag.length);
  console.log("instruction length:", instructions.length);
  console.log("courseName:",courseName);
  console.log("courseDescription:",courseDescription);
  console.log("whatuwillLearn:",whatYouWillLearn);
...
// show AllCourses  handler function
